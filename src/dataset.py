...
#modifiquei o segundo argumento de join para all_images para ler meu dataset na estrutura que está
def carregar_dataset(caminho):
  X_train = sorted(glob(os.path.join(caminho, "all_images", "*.tif")))
  y_train = sorted(glob(os.path.join(caminho, "all_masks", "*.tif")))
